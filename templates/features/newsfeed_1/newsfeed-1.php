...
/* Feature Name: Newsfeed v.1.1
 * Feature Function: Newsfeed, used universally for blog and list pages
 * Date: 2015
 * Last Modified: 08/02/2017
 * Notes : Added font awesome arrow options, merge other theme's newsfeed, move functions to utils. Added option to display author on newsfeed
 * 
 * */
