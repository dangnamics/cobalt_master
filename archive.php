<?php
/*
Note: Archive overview
 */
$year = get_query_var('year'); // get archive year
...
$the_query = query_posts("year={$year}&post_type=post&post_status=publish&posts_per_page={$postPerPage}&paged={$pageNo}{$queryString}");
